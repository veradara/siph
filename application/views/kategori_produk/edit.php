<div class="">
  <div class="page-title">
    <div class="title_left">
      <h3><i class="fa fa-file-text"></i>Edit Kategori</h3>
    </div>
  </div>
 <script type="text/javascript" src="<?php echo base_url();?>assets/ckeditor/ckeditor.js" charset="utf-8"></script>
  ...
  <div class="x_panel">
    ...
    <div class="x_content">
      ...
      <?php } ?>
      <form role="form" action="<?php echo base_url() ?>kategori_produk/edit_process" method="post" enctype="multipart/form-data">
        <input type="hidden" name="id_product_categories" value="<?=$detail['id_product_categories']?>">
        <div class="form-group">
          <label for="judul">Nama Kategori</label>
          <input type="text" class="form-control" name="name_categories" id="judul" value="<?=$detail['name_categories']?>">
        </div>
