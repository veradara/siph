<div class="">
  <div class="page-title">
    <div class="title_left">
      <h3><i class="fa fa-file-text"></i>Edit users</h3>
    </div>
  </div>
  ...
  <div class="x_panel">
    ...
    <div class="x_content">
      ...
      <?php } ?>
      <form role="form" action="<?php echo base_url() ?>users/edit_process" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
          ...
          <input type="date" class="form-control" name="birthday" id="birthday" value="<?= $detail['birthday'] ?>">
        </div>
        ...
        <hr>
        <h5 style="color: red">Kosongi password jika tidak ingin diganti !!</h5>
        <div class="form-group">
